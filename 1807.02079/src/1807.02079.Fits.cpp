...
int main(int argc, char *argv[])
{
	...
	string listname = string(ThermalFIST_INPUT_FOLDER) + "/list/PDG2014/list-withnuclei.dat";
	...
	datafilenames.push_back(string(ThermalFIST_INPUT_FOLDER) + "/../../input/data/ALICE-PbPb2.76TeV-0-10-all-symmetrized-nuclei.dat");
	outputnames.push_back("0-10-with-nuclei");

	// 0-10%, no light nuclei
	datafilenames.push_back(string(ThermalFIST_INPUT_FOLDER) + "/../../input/data/ALICE-PbPb2.76TeV-0-10-all-symmetrized.dat");
	outputnames.push_back("0-10");

	// 10-20%, no light nuclei
	datafilenames.push_back(string(ThermalFIST_INPUT_FOLDER) + "/../../input/data/ALICE-PbPb2.76TeV-10-20-all-symmetrized.dat");
	outputnames.push_back("10-20");

	// 20-40%, no light nuclei
	datafilenames.push_back(string(ThermalFIST_INPUT_FOLDER) + "/../../input/data/ALICE-PbPb2.76TeV-20-40-all-symmetrized.dat");
	outputnames.push_back("20-40");

	// 40-60%, no light nuclei
	datafilenames.push_back(string(ThermalFIST_INPUT_FOLDER) + "/../../input/data/ALICE-PbPb2.76TeV-40-60-all-symmetrized.dat");
	outputnames.push_back("40-60");

	// 60-80%, no light nuclei
	datafilenames.push_back(string(ThermalFIST_INPUT_FOLDER) + "/../../input/data/ALICE-PbPb2.76TeV-60-80-all-symmetrized.dat");
