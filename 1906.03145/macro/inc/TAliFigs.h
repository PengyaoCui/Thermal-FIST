...
const Style_t wls[] = { kSolid, 7, kDashDotted, kDashed, kDotted};
//=============================================================================
...
void DrawGraph(TGraph* const g, const Color_t wc, const Style_t ws, const Style_t wls, const Option_t *opt)
{
  g->SetLineWidth(2);
  g->SetLineColor(wc);
  g->SetMarkerStyle(ws);
